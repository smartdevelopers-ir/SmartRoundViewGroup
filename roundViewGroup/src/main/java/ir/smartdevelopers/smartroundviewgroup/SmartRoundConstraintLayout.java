...
//        setWillNotDraw(false);
        ...
        if (attrs!=null){
          ...
          mShowShadow=typedArray.getBoolean(R.styleable.SmartRoundConstraintLayout_showShadow,false);
           ...
           int gradientStartColor=typedArray.getColor(R.styleable.SmartRoundConstraintLayout_gradientStartColor,0);
           int gradientEndColor=typedArray.getColor(R.styleable.SmartRoundConstraintLayout_gradientEndColor,0);
